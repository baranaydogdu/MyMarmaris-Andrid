...
public class SettingFragment extends Fragment {
    ...
    SearchMainFragment searcFragment;
    FragmentFavorittes favoritteFragment;

    public SettingFragment(SearchMainFragment searcFragment,FragmentFavorittes favoritteFragment) {

        this.searcFragment = searcFragment;
        this.favoritteFragment = favoritteFragment;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        clear_carvdiew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                realm.where(HistoryRealm.class).findAll().deleteAllFromRealm();
                realm.commitTransaction();
                searcFragment.onResume();
                Toast.makeText(getActivity(),new LanguagePack().allhistorydeleted[selected_language],Toast.LENGTH_SHORT).show();
        ...
        clear_favlist_carvdiew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Realm realm = Realm.getDefaultInstance();
                realm.beginTransaction();
                realm.where(FavoritteRealm.class).findAll().deleteAllFromRealm();
                realm.commitTransaction();
                favoritteFragment.onResume();
                Toast.makeText(getActivity(),new LanguagePack().allfavlist_deleted[selected_language],Toast.LENGTH_SHORT).show();
