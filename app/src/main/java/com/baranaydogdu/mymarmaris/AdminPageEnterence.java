...
import com.baranaydogdu.mymarmaris.EventsEdits.EventsEdit;
import com.baranaydogdu.mymarmaris.PlaceCollectionEdits.PlacesEditCollections;
...
public class AdminPageEnterence extends AppCompatActivity {
    ...
    Button      sign_in_button,places_button,events_button,notifications_button,sign_out_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        places_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =new Intent(activity, PlacesEditCollections.class);
        ...
        events_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =new Intent(activity, EventsEdit.class);
                startActivity(intent);
            }
        });
    ...
    private void set_UnAuthorized() {
        ...
        places_button.setVisibility(View.INVISIBLE);
        events_button.setVisibility(View.INVISIBLE);
    ...
    private void setAuthirezed() {
        ...
        places_button.setVisibility(View.VISIBLE);
        events_button.setVisibility(View.VISIBLE);
    ...
    private void startsmth(){
        ...
        places_button           .setEnabled(false);
        events_button           .setEnabled(false);
